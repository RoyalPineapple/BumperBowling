...
- Added static interpretation of declarative configurations: `BumperBowling.swift`
  files inside the DSL subset load through SwiftSyntax without compiling or
  executing any configuration code.
