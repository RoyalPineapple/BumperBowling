...
public enum BumperCommands {
    ...
    public static func snapshot(root: URL) throws -> String {
        ...
        for commandName in commandNames {
            let nodeID = snapshotNodeID(for: commandName)
        ...
        lines.append("    Snapshot --> ConfigLoader")
        ...
        for rule in enabledRules {
            let nodeID = snapshotNodeID(for: rule.id.rawValue)
        ...
        for rule in enabledRules {
            lines.append("    \(snapshotNodeID(for: rule.id.rawValue)) --> Report[\"LintReport\"]")
        }
